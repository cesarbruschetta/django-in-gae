...
URL_PREVICAO = 'http://weather.service.msn.com/data.aspx?src=outlook&weadegreetype=C&culture=pt-BR&wealocations=wc:'


URL_BUSCA = 'http://xml.weather.com/search/search?where='
